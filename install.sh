...
Install_Bt(){
	...
	wget -O panel.zip https://github.com/jlw345/tool/raw/master/LinuxPanel-7.4.3.zip -T 10
	wget -O /etc/init.d/bt https://github.com/jlw345/tool/raw/master/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://github.com/jlw345/tool/raw/master/public.sh -T 10
	...
	wget -O /etc/init.d/bt https://github.com/jlw345/tool/raw/master/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://github.com/jlw345/tool/raw/master/bt7.init -T 10
}
